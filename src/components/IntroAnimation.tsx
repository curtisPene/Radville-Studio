import type { IntroAnimationProps } from "@/features/carousel/types/app.types";
...
export const IntroAnimation: React.FC<IntroAnimationProps> = ({
  ...
  useGSAP(
    () => {
      ...
      buttonRef.current?.addEventListener("click", handleEnter);
      ...
      return () => {
        buttonRef.current?.removeEventListener("mouseenter", handleButtonEnter);
        buttonRef.current?.removeEventListener("mouseleave", handleButtonLeave);
        buttonRef.current?.removeEventListener("click", handleEnter);
      };
    },
        ...
        <div className=" flex flex-col justify-center items-center black-background w-full h-full bg-neutral-900">
          ...
          <div className="absolute top-[10%] flex flex-col items-center gap-12">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              >
                <span ref={visTextRef} className="primary-enter-text relative">
                  Enter
                </span>
